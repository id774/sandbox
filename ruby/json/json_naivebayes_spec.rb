  ...
  context 'の classify メソッドにおいて' do
    describe 'クラスに教師データと分類対象のファイルを引数として与えると' do
      it 'クラスとその数値が出力される' do
        ...
        expected = [
          "1111,activity,xxxx銀行センター運用\t情報収集,受注\t{\"要望未達\"=>0.008635041608209649, \"要員不在\"=>0.006061740971066253, \"価格\"=>0.6665582994367619, \"経験値\"=>0.003937420381937798, \"顧客都合\"=>0.2768245659950986, \"提案不足\"=>0.010572902398813842, \"リスキー\"=>0.027410029208112047}\n",
          "2222,activity,yyyy銀行センター運用\t情報収集,失注\t{\"要望未達\"=>0.01169311377334736, \"要員不在\"=>0.13132219731748304, \"価格\"=>0.4416383146053236, \"経験値\"=>0.0027247254383802456, \"顧客都合\"=>0.3642272794557206, \"提案不足\"=>0.029701299802490047, \"リスキー\"=>0.018693069607254913}\n"
        ]
