...
if __name__ == "__main__":
    ...
    sent = "老人の承認欲求に彩られ無限に湧き出る責任感から、文字通り死に物狂いでチェ ーンカッターを振りかざした挙句腰が再起不能になるなどして視聴者の涙を誘い、プロ市民が「老人を虐待するな！！」と抗議の電話を掛け、老人を一掃して若者の雇用を試みるも、軟弱な若者は一行に志願せず頓挫というシナリオ".encode('UTF-8')
    print(sent)
