#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Classify with transformed weight normalized complement naive Bayes.
...
class TWCNB(object):
    ...
    def _calc_category_word_count(self, data):
        """Compute the frequency of each word in each category
        Apply TF transform, IDF transform, and length normalization to them
        """
    ...
    def _calc_complement_category_word_count(self, category_word_count, all_words):
        """Compute the same frequency over the complement of a category
        """
    ...
    def _calc_category_word_weight(self, complement_category_word_count, alpha):
        """Compute the weight of each word in each category
        """
    ...
    def _calc_normalized_category_word_weight(self, category_word_weight):
        """Normalize those weights, that is weight normalization
        """
