...
#第1四分位
print( "第 1 四分位 1Q x:" + str(stats.scoreatpercentile(X, 25)) + " y: " + str(stats.scoreatpercentile(Y, 25)) )
#中央値
print( "中央値 Med x: " + str(numpy.median(X)) + " y: " + str(numpy.median(Y)) )
#第3四分位
print( "第 3 四分位 3Q x:" + str(stats.scoreatpercentile(X, 75)) + " y: " + str(stats.scoreatpercentile(Y, 75)) )
#分散
